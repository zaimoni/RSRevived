...
namespace djack.RogueSurvivor.Gameplay
{
  internal class GameActors : ActorModelDB
  {
    ...
    public void CreateModels()
    {
      ...
      this[GameActors.IDs.UNDEAD_RED_EYED_SKELETON] = new ActorModel("Actors\\red_eyed_skeleton", DATA_RED_EYED_SKELETON.NAME, DATA_RED_EYED_SKELETON.PLURAL, DATA_RED_EYED_SKELETON.SCORE, DATA_RED_EYED_SKELETON.FLAVOR, new DollBody(true, DATA_RED_EYED_SKELETON.SPD), new Abilities(
          Abilities.Flags.UNDEAD),
      ...
      this[GameActors.IDs.UNDEAD_RED_SKELETON] = new ActorModel("Actors\\red_skeleton", DATA_RED_SKELETON.NAME, DATA_RED_SKELETON.PLURAL, DATA_RED_SKELETON.SCORE, DATA_RED_SKELETON.FLAVOR, new DollBody(true, DATA_RED_SKELETON.SPD), new Abilities(
          Abilities.Flags.UNDEAD),
      ...
      this[GameActors.IDs.UNDEAD_ZOMBIE] = new ActorModel("Actors\\zombie", DATA_ZOMBIE.NAME, DATA_ZOMBIE.PLURAL, DATA_ZOMBIE.SCORE, DATA_ZOMBIE.FLAVOR, new DollBody(true, DATA_ZOMBIE.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_DARK_EYED_ZOMBIE] = new ActorModel("Actors\\dark_eyed_zombie", DATA_DARK_EYED_ZOMBIE.NAME, DATA_DARK_EYED_ZOMBIE.PLURAL, DATA_DARK_EYED_ZOMBIE.SCORE, DATA_DARK_EYED_ZOMBIE.FLAVOR, new DollBody(true, DATA_DARK_EYED_ZOMBIE.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_DARK_ZOMBIE] = new ActorModel("Actors\\dark_zombie", DATA_DARK_ZOMBIE.NAME, DATA_DARK_ZOMBIE.PLURAL, DATA_DARK_ZOMBIE.SCORE, DATA_DARK_ZOMBIE.FLAVOR, new DollBody(true, DATA_DARK_ZOMBIE.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_MALE_ZOMBIFIED] = new ActorModel((string) null, DATA_MALE_ZOMBIFIED.NAME, DATA_MALE_ZOMBIFIED.PLURAL, DATA_MALE_ZOMBIFIED.SCORE, DATA_MALE_ZOMBIFIED.FLAVOR, new DollBody(true, DATA_MALE_ZOMBIFIED.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_FEMALE_ZOMBIFIED] = new ActorModel((string) null, DATA_FEMALE_ZOMBIFIED.NAME, DATA_FEMALE_ZOMBIFIED.PLURAL, DATA_FEMALE_ZOMBIFIED.SCORE, DATA_FEMALE_ZOMBIFIED.FLAVOR, new DollBody(true, DATA_FEMALE_ZOMBIFIED.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_MALE_NEOPHYTE] = new ActorModel("Actors\\male_neophyte", DATA_MALE_NEOPHYTE.NAME, DATA_MALE_NEOPHYTE.PLURAL, DATA_MALE_NEOPHYTE.SCORE, DATA_MALE_NEOPHYTE.FLAVOR, new DollBody(true, DATA_MALE_NEOPHYTE.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.CAN_PUSH | Abilities.Flags.ZOMBIEAI_ASSAULT_BREAKABLES |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_FEMALE_NEOPHYTE] = new ActorModel("Actors\\female_neophyte", DATA_FEMALE_NEOPHYTE.NAME, DATA_FEMALE_NEOPHYTE.PLURAL, DATA_FEMALE_NEOPHYTE.SCORE, DATA_FEMALE_NEOPHYTE.FLAVOR, new DollBody(true, DATA_FEMALE_NEOPHYTE.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.CAN_PUSH | Abilities.Flags.ZOMBIEAI_ASSAULT_BREAKABLES |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_MALE_DISCIPLE] = new ActorModel("Actors\\male_disciple", DATA_MALE_DISCIPLE.NAME, DATA_MALE_DISCIPLE.PLURAL, DATA_MALE_DISCIPLE.SCORE, DATA_MALE_DISCIPLE.FLAVOR, new DollBody(true, DATA_MALE_DISCIPLE.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.CAN_PUSH | Abilities.Flags.ZOMBIEAI_ASSAULT_BREAKABLES |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_FEMALE_DISCIPLE] = new ActorModel("Actors\\female_disciple", DATA_FEMALE_DISCIPLE.NAME, DATA_FEMALE_DISCIPLE.PLURAL, DATA_FEMALE_DISCIPLE.SCORE, DATA_FEMALE_DISCIPLE.FLAVOR, new DollBody(true, DATA_FEMALE_DISCIPLE.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.CAN_PUSH | Abilities.Flags.ZOMBIEAI_ASSAULT_BREAKABLES |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_ZOMBIE_MASTER] = new ActorModel("Actors\\zombie_master", DATA_ZM.NAME, DATA_ZM.PLURAL, DATA_ZM.SCORE, DATA_ZM.FLAVOR, new DollBody(true, DATA_ZM.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.UNDEAD_MASTER | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_JUMP_STUMBLE | Abilities.Flags.CAN_PUSH |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS),
      ...
      this[GameActors.IDs.UNDEAD_ZOMBIE_LORD] = new ActorModel("Actors\\zombie_lord", DATA_ZL.NAME, DATA_ZL.PLURAL, DATA_ZL.SCORE, DATA_ZL.FLAVOR, new DollBody(true, DATA_ZL.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.UNDEAD_MASTER | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_JUMP_STUMBLE | Abilities.Flags.CAN_PUSH |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS | Abilities.Flags.ZOMBIEAI_ASSAULT_BREAKABLES),
      ...
      this[GameActors.IDs.UNDEAD_ZOMBIE_PRINCE] = new ActorModel("Actors\\zombie_prince", DATA_ZP.NAME, DATA_ZP.PLURAL, DATA_ZP.SCORE, DATA_ZP.FLAVOR, new DollBody(true, DATA_ZP.SPD), new Abilities(
          Abilities.Flags.UNDEAD | Abilities.Flags.IS_ROTTING | Abilities.Flags.CAN_ZOMBIFY_KILLED | Abilities.Flags.CAN_BASH_DOORS | Abilities.Flags.CAN_BREAK_OBJECTS |
          Abilities.Flags.UNDEAD_MASTER | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_JUMP_STUMBLE | Abilities.Flags.CAN_PUSH |
          Abilities.Flags.ZOMBIEAI_EXPLORE | Abilities.Flags.AI_CAN_USE_AI_EXITS | Abilities.Flags.ZOMBIEAI_ASSAULT_BREAKABLES),
      ...
      this[GameActors.IDs.UNDEAD_RAT_ZOMBIE] = new ActorModel("Actors\\rat_zombie", DATA_RAT_ZOMBIE.NAME, DATA_RAT_ZOMBIE.PLURAL, DATA_RAT_ZOMBIE.SCORE, DATA_RAT_ZOMBIE.FLAVOR, new DollBody(true, DATA_RAT_ZOMBIE.SPD), new Abilities(
      ...
      this[GameActors.IDs.SEWERS_THING] = new ActorModel("Actors\\sewers_thing", DATA_SEWERS_THING.NAME, DATA_SEWERS_THING.PLURAL, DATA_SEWERS_THING.SCORE, DATA_SEWERS_THING.FLAVOR, new DollBody(true, DATA_SEWERS_THING.SPD), new Abilities(
      ...
      this[GameActors.IDs.MALE_CIVILIAN] = new ActorModel((string) null, DATA_MALE_CIVILIAN.NAME, DATA_MALE_CIVILIAN.PLURAL, DATA_MALE_CIVILIAN.SCORE, DATA_MALE_CIVILIAN.FLAVOR, new DollBody(true, DATA_MALE_CIVILIAN.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE | Abilities.Flags.HAS_SANITY | Abilities.Flags.CAN_TRADE |
          Abilities.Flags.HAS_TO_EAT | Abilities.Flags.HAS_TO_SLEEP | Abilities.Flags.AI_CAN_USE_AI_EXITS | Abilities.Flags.IS_INTELLIGENT),
      ...
      this[GameActors.IDs.FEMALE_CIVILIAN] = new ActorModel((string) null, DATA_FEMALE_CIVILIAN.NAME, DATA_FEMALE_CIVILIAN.PLURAL, DATA_FEMALE_CIVILIAN.SCORE, DATA_FEMALE_CIVILIAN.FLAVOR, new DollBody(false, DATA_FEMALE_CIVILIAN.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE | Abilities.Flags.HAS_SANITY | Abilities.Flags.CAN_TRADE |
          Abilities.Flags.HAS_TO_EAT | Abilities.Flags.HAS_TO_SLEEP | Abilities.Flags.AI_CAN_USE_AI_EXITS | Abilities.Flags.IS_INTELLIGENT), new ActorSheet(DATA_FEMALE_CIVILIAN.HP, DATA_FEMALE_CIVILIAN.STA, HUMAN_HUN, HUMAN_SLP, HUMAN_SAN, new Attack(AttackKind.PHYSICAL, GameActors.VERB_PUNCH, DATA_FEMALE_CIVILIAN.ATK, DATA_FEMALE_CIVILIAN.DMG), new Defence(DATA_FEMALE_CIVILIAN.DEF, DATA_FEMALE_CIVILIAN.PRO_HIT, DATA_FEMALE_CIVILIAN.PRO_SHOT), DATA_FEMALE_CIVILIAN.FOV, DATA_FEMALE_CIVILIAN.AUDIO, NO_SMELL, HUMAN_INVENTORY), typeof (CivilianAI));
      this[GameActors.IDs.CHAR_GUARD] = new ActorModel((string) null, DATA_CHAR_GUARD.NAME, DATA_CHAR_GUARD.PLURAL, DATA_CHAR_GUARD.SCORE, DATA_CHAR_GUARD.FLAVOR, new DollBody(true, DATA_CHAR_GUARD.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE | Abilities.Flags.HAS_SANITY |
          Abilities.Flags.HAS_TO_SLEEP | Abilities.Flags.IS_INTELLIGENT),
          new ActorSheet(DATA_CHAR_GUARD.HP, DATA_CHAR_GUARD.STA, NO_FOOD, HUMAN_SLP, HUMAN_SAN, new Attack(AttackKind.PHYSICAL, GameActors.VERB_PUNCH, DATA_CHAR_GUARD.ATK, DATA_CHAR_GUARD.DMG), new Defence(DATA_CHAR_GUARD.DEF, DATA_CHAR_GUARD.PRO_HIT, DATA_CHAR_GUARD.PRO_SHOT), DATA_CHAR_GUARD.FOV, DATA_CHAR_GUARD.AUDIO, NO_SMELL, HUMAN_INVENTORY), typeof (CHARGuardAI));
      this[GameActors.IDs.ARMY_NATIONAL_GUARD] = new ActorModel((string) null, DATA_NATGUARD.NAME, DATA_NATGUARD.PLURAL, DATA_NATGUARD.SCORE, DATA_NATGUARD.FLAVOR, new DollBody(true, DATA_NATGUARD.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE | Abilities.Flags.HAS_SANITY |
          Abilities.Flags.HAS_TO_SLEEP | Abilities.Flags.IS_INTELLIGENT),
          new ActorSheet(DATA_NATGUARD.HP, DATA_NATGUARD.STA, NO_FOOD, HUMAN_SLP, HUMAN_SAN, new Attack(AttackKind.PHYSICAL, GameActors.VERB_PUNCH, DATA_NATGUARD.ATK, DATA_NATGUARD.DMG), new Defence(DATA_NATGUARD.DEF, DATA_NATGUARD.PRO_HIT, DATA_NATGUARD.PRO_SHOT), DATA_NATGUARD.FOV, DATA_NATGUARD.AUDIO, NO_SMELL, HUMAN_INVENTORY), typeof (SoldierAI));
      this[GameActors.IDs.BIKER_MAN] = new ActorModel((string) null, DATA_BIKER_MAN.NAME, DATA_BIKER_MAN.PLURAL, DATA_BIKER_MAN.SCORE, DATA_BIKER_MAN.FLAVOR, new DollBody(true, DATA_BIKER_MAN.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE | Abilities.Flags.HAS_SANITY | Abilities.Flags.CAN_TRADE |
          Abilities.Flags.HAS_TO_EAT | Abilities.Flags.HAS_TO_SLEEP | Abilities.Flags.IS_INTELLIGENT | Abilities.Flags.AI_NOT_INTERESTED_IN_RANGED_WEAPONS),
      ...
      this[GameActors.IDs.GANGSTA_MAN] = new ActorModel((string) null, DATA_GANGSTA_MAN.NAME, DATA_GANGSTA_MAN.PLURAL, DATA_GANGSTA_MAN.SCORE, DATA_GANGSTA_MAN.FLAVOR, new DollBody(true, DATA_GANGSTA_MAN.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE | Abilities.Flags.HAS_SANITY | Abilities.Flags.CAN_TRADE |
          Abilities.Flags.HAS_TO_EAT | Abilities.Flags.HAS_TO_SLEEP | Abilities.Flags.IS_INTELLIGENT),
      ...
      this[GameActors.IDs.POLICEMAN] = new ActorModel((string) null, DATA_POLICEMAN.NAME, DATA_POLICEMAN.PLURAL, DATA_POLICEMAN.SCORE, DATA_POLICEMAN.FLAVOR, new DollBody(true, DATA_POLICEMAN.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE | Abilities.Flags.HAS_SANITY | Abilities.Flags.CAN_TRADE |
          Abilities.Flags.HAS_TO_EAT | Abilities.Flags.HAS_TO_SLEEP | Abilities.Flags.AI_CAN_USE_AI_EXITS | Abilities.Flags.IS_INTELLIGENT | Abilities.Flags.IS_LAW_ENFORCER),
      ...
      this[GameActors.IDs.BLACKOPS_MAN] = new ActorModel((string) null, DATA_BLACKOPS_MAN.NAME, DATA_BLACKOPS_MAN.PLURAL, DATA_BLACKOPS_MAN.SCORE, DATA_BLACKOPS_MAN.FLAVOR, new DollBody(true, DATA_BLACKOPS_MAN.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE | Abilities.Flags.HAS_SANITY |
          Abilities.Flags.HAS_TO_SLEEP | Abilities.Flags.IS_INTELLIGENT),
          new ActorSheet(DATA_BLACKOPS_MAN.HP, DATA_BLACKOPS_MAN.STA, NO_FOOD, HUMAN_SLP, HUMAN_SAN, new Attack(AttackKind.PHYSICAL, GameActors.VERB_PUNCH, DATA_BLACKOPS_MAN.ATK, DATA_BLACKOPS_MAN.DMG), new Defence(DATA_BLACKOPS_MAN.DEF, DATA_BLACKOPS_MAN.PRO_HIT, DATA_BLACKOPS_MAN.PRO_SHOT), DATA_BLACKOPS_MAN.FOV, DATA_BLACKOPS_MAN.AUDIO, NO_SMELL, HUMAN_INVENTORY), typeof (SoldierAI));
      GameActors.ActorData actorData = DATA_FERAL_DOG;
      this[GameActors.IDs.FERAL_DOG] = new ActorModel((string) null, actorData.NAME, actorData.PLURAL, actorData.SCORE, actorData.FLAVOR, new DollBody(true, actorData.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
      ...
      this[GameActors.IDs.JASON_MYERS] = new ActorModel((string) null, DATA_JASON_MYERS.NAME, DATA_JASON_MYERS.PLURAL, DATA_JASON_MYERS.SCORE, DATA_JASON_MYERS.FLAVOR, new DollBody(true, DATA_JASON_MYERS.SPD), new Abilities(
          Abilities.Flags.HAS_INVENTORY | Abilities.Flags.CAN_USE_MAP_OBJECTS | Abilities.Flags.CAN_BREAK_OBJECTS | Abilities.Flags.CAN_JUMP | Abilities.Flags.CAN_TIRE | Abilities.Flags.CAN_RUN |
          Abilities.Flags.CAN_USE_ITEMS | Abilities.Flags.CAN_TALK | Abilities.Flags.CAN_PUSH | Abilities.Flags.CAN_BARRICADE |
          Abilities.Flags.AI_CAN_USE_AI_EXITS),
          new ActorSheet(DATA_JASON_MYERS.HP, DATA_JASON_MYERS.STA, NO_FOOD, NO_SLEEP, NO_SANITY, new Attack(AttackKind.PHYSICAL, GameActors.VERB_PUNCH, DATA_JASON_MYERS.ATK, DATA_JASON_MYERS.DMG), new Defence(DATA_JASON_MYERS.DEF, DATA_JASON_MYERS.PRO_HIT, DATA_JASON_MYERS.PRO_SHOT), DATA_JASON_MYERS.FOV, DATA_JASON_MYERS.AUDIO, NO_SMELL, HUMAN_INVENTORY), typeof (InsaneHumanAI));
    }
