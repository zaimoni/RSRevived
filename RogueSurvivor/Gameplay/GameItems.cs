...
namespace djack.RogueSurvivor.Gameplay
{
  internal class GameItems : ItemModelDB
  {
    ...
    public void CreateModels()
    {
      ...
      // melee weapons
      this[GameItems.IDs.MELEE_BASEBALLBAT] = new ItemMeleeWeaponModel(DATA_MELEE_BASEBALLBAT.NAME, DATA_MELEE_BASEBALLBAT.PLURAL, GameImages.ITEM_BASEBALL_BAT, new Attack(AttackKind.PHYSICAL, SMASH, DATA_MELEE_BASEBALLBAT.ATK, DATA_MELEE_BASEBALLBAT.DMG, DATA_MELEE_BASEBALLBAT.STA), DATA_MELEE_BASEBALLBAT.FLAVOR) { IsFragile = DATA_MELEE_BASEBALLBAT.ISFRAGILE };
      ...
      this[GameItems.IDs.MELEE_GOLFCLUB] = new ItemMeleeWeaponModel(DATA_MELEE_GOLFCLUB.NAME, DATA_MELEE_GOLFCLUB.PLURAL, GameImages.ITEM_GOLF_CLUB, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_GOLFCLUB.ATK, DATA_MELEE_GOLFCLUB.DMG, DATA_MELEE_GOLFCLUB.STA), DATA_MELEE_GOLFCLUB.FLAVOR) { IsFragile = DATA_MELEE_GOLFCLUB.ISFRAGILE };
      ...
      this[GameItems.IDs.MELEE_SHOVEL] = new ItemMeleeWeaponModel(DATA_MELEE_SHOVEL.NAME, DATA_MELEE_SHOVEL.PLURAL, GameImages.ITEM_SHOVEL, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_SHOVEL.ATK, DATA_MELEE_SHOVEL.DMG, DATA_MELEE_SHOVEL.STA), DATA_MELEE_SHOVEL.FLAVOR) { IsFragile = DATA_MELEE_SHOVEL.ISFRAGILE };
      this[GameItems.IDs.MELEE_SHOVEL].StackingLimit = DATA_MELEE_SHOVEL.STACKINGLIMIT;
      this[GameItems.IDs.MELEE_SHORT_SHOVEL] = new ItemMeleeWeaponModel(DATA_MELEE_SHORT_SHOVEL.NAME, DATA_MELEE_SHORT_SHOVEL.PLURAL, GameImages.ITEM_SHORT_SHOVEL, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_SHORT_SHOVEL.ATK, DATA_MELEE_SHORT_SHOVEL.DMG, DATA_MELEE_SHORT_SHOVEL.STA), DATA_MELEE_SHORT_SHOVEL.FLAVOR){ IsFragile = DATA_MELEE_SHORT_SHOVEL.ISFRAGILE };
