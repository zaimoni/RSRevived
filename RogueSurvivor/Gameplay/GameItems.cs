...
namespace djack.RogueSurvivor.Gameplay
{
  internal class GameItems : ItemModelDB
  {
    ...
    private void CreateModels()
    {
      ...
      // melee weapons
      _setModel(IDs.MELEE_BASEBALLBAT, new ItemMeleeWeaponModel(DATA_MELEE_BASEBALLBAT.NAME, GameImages.ITEM_BASEBALL_BAT, new Attack(AttackKind.PHYSICAL, SMASH, DATA_MELEE_BASEBALLBAT.ATK, DATA_MELEE_BASEBALLBAT.DMG, DATA_MELEE_BASEBALLBAT.STA), DATA_MELEE_BASEBALLBAT.FLAVOR, DATA_MELEE_BASEBALLBAT.STACKINGLIMIT, DATA_MELEE_BASEBALLBAT.ISFRAGILE));
      _setModel(IDs.MELEE_COMBAT_KNIFE, new ItemMeleeWeaponModel(DATA_MELEE_COMBAT_KNIFE.NAME, GameImages.ITEM_COMBAT_KNIFE, new Attack(AttackKind.PHYSICAL, STAB, DATA_MELEE_COMBAT_KNIFE.ATK, DATA_MELEE_COMBAT_KNIFE.DMG, DATA_MELEE_COMBAT_KNIFE.STA), DATA_MELEE_COMBAT_KNIFE.FLAVOR, DATA_MELEE_COMBAT_KNIFE.STACKINGLIMIT, DATA_MELEE_COMBAT_KNIFE.ISFRAGILE));
      _setModel(IDs.MELEE_CROWBAR, new ItemMeleeWeaponModel(DATA_MELEE_CROWBAR.NAME, GameImages.ITEM_CROWBAR, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_CROWBAR.ATK, DATA_MELEE_CROWBAR.DMG, DATA_MELEE_CROWBAR.STA), DATA_MELEE_CROWBAR.FLAVOR, DATA_MELEE_CROWBAR.STACKINGLIMIT, DATA_MELEE_CROWBAR.ISFRAGILE));
      _setModel(IDs.MELEE_GOLFCLUB, new ItemMeleeWeaponModel(DATA_MELEE_GOLFCLUB.NAME, GameImages.ITEM_GOLF_CLUB, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_GOLFCLUB.ATK, DATA_MELEE_GOLFCLUB.DMG, DATA_MELEE_GOLFCLUB.STA), DATA_MELEE_GOLFCLUB.FLAVOR, DATA_MELEE_GOLFCLUB.STACKINGLIMIT, DATA_MELEE_GOLFCLUB.ISFRAGILE));
      _setModel(IDs.MELEE_IRON_GOLFCLUB, new ItemMeleeWeaponModel(DATA_MELEE_IRON_GOLFCLUB.NAME, GameImages.ITEM_IRON_GOLF_CLUB, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_IRON_GOLFCLUB.ATK, DATA_MELEE_IRON_GOLFCLUB.DMG, DATA_MELEE_IRON_GOLFCLUB.STA), DATA_MELEE_IRON_GOLFCLUB.FLAVOR, DATA_MELEE_IRON_GOLFCLUB.STACKINGLIMIT, DATA_MELEE_IRON_GOLFCLUB.ISFRAGILE));
      _setModel(IDs.MELEE_HUGE_HAMMER, new ItemMeleeWeaponModel(DATA_MELEE_HUGE_HAMMER.NAME, GameImages.ITEM_HUGE_HAMMER, new Attack(AttackKind.PHYSICAL, SMASH, DATA_MELEE_HUGE_HAMMER.ATK, DATA_MELEE_HUGE_HAMMER.DMG, DATA_MELEE_HUGE_HAMMER.STA), DATA_MELEE_HUGE_HAMMER.FLAVOR, DATA_MELEE_HUGE_HAMMER.STACKINGLIMIT, DATA_MELEE_HUGE_HAMMER.ISFRAGILE));
      _setModel(IDs.MELEE_SHOVEL, new ItemMeleeWeaponModel(DATA_MELEE_SHOVEL.NAME, GameImages.ITEM_SHOVEL, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_SHOVEL.ATK, DATA_MELEE_SHOVEL.DMG, DATA_MELEE_SHOVEL.STA), DATA_MELEE_SHOVEL.FLAVOR, DATA_MELEE_SHOVEL.STACKINGLIMIT, DATA_MELEE_SHOVEL.ISFRAGILE));
      _setModel(IDs.MELEE_SHORT_SHOVEL, new ItemMeleeWeaponModel(DATA_MELEE_SHORT_SHOVEL.NAME, GameImages.ITEM_SHORT_SHOVEL, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_SHORT_SHOVEL.ATK, DATA_MELEE_SHORT_SHOVEL.DMG, DATA_MELEE_SHORT_SHOVEL.STA), DATA_MELEE_SHORT_SHOVEL.FLAVOR, DATA_MELEE_SHORT_SHOVEL.STACKINGLIMIT, DATA_MELEE_SHORT_SHOVEL.ISFRAGILE));
      _setModel(IDs.MELEE_TRUNCHEON, new ItemMeleeWeaponModel(DATA_MELEE_TRUNCHEON.NAME, GameImages.ITEM_TRUNCHEON, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_TRUNCHEON.ATK, DATA_MELEE_TRUNCHEON.DMG, DATA_MELEE_TRUNCHEON.STA), DATA_MELEE_TRUNCHEON.FLAVOR, DATA_MELEE_TRUNCHEON.STACKINGLIMIT, DATA_MELEE_TRUNCHEON.ISFRAGILE));
      _setModel(IDs.MELEE_IMPROVISED_CLUB, new ItemMeleeWeaponModel(DATA_MELEE_IMPROVISED_CLUB.NAME, GameImages.ITEM_IMPROVISED_CLUB, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_IMPROVISED_CLUB.ATK, DATA_MELEE_IMPROVISED_CLUB.DMG, DATA_MELEE_IMPROVISED_CLUB.STA), DATA_MELEE_IMPROVISED_CLUB.FLAVOR, DATA_MELEE_IMPROVISED_CLUB.STACKINGLIMIT, DATA_MELEE_IMPROVISED_CLUB.ISFRAGILE));
      _setModel(IDs.MELEE_IMPROVISED_SPEAR, new ItemMeleeWeaponModel(DATA_MELEE_IMPROVISED_SPEAR.NAME, GameImages.ITEM_IMPROVISED_SPEAR, new Attack(AttackKind.PHYSICAL, PIERCE, DATA_MELEE_IMPROVISED_SPEAR.ATK, DATA_MELEE_IMPROVISED_SPEAR.DMG, DATA_MELEE_IMPROVISED_SPEAR.STA), DATA_MELEE_IMPROVISED_SPEAR.FLAVOR, DATA_MELEE_IMPROVISED_SPEAR.STACKINGLIMIT, DATA_MELEE_IMPROVISED_SPEAR.ISFRAGILE));
      _setModel(IDs.MELEE_SMALL_HAMMER, new ItemMeleeWeaponModel(DATA_MELEE_SMALL_HAMMER.NAME, GameImages.ITEM_SMALL_HAMMER, new Attack(AttackKind.PHYSICAL, SMASH, DATA_MELEE_SMALL_HAMMER.ATK, DATA_MELEE_SMALL_HAMMER.DMG, DATA_MELEE_SMALL_HAMMER.STA), DATA_MELEE_SMALL_HAMMER.FLAVOR, DATA_MELEE_SMALL_HAMMER.STACKINGLIMIT, DATA_MELEE_SMALL_HAMMER.ISFRAGILE));
