...
namespace djack.RogueSurvivor.Gameplay
{
  internal static class GameItems
  {
                              ...
                              ScentSprayData[] scent_data, TrapData[] trap_data, EntData[] ent_data)
    {
      ...
      MeleeWeaponData DATA_MELEE_UNIQUE_FATHER_TIME_SCYTHE = melee_data[(int)IDs.UNIQUE_FATHER_TIME_SCYTHE - (int)IDs.UNIQUE_FAMU_FATARU_KATANA + ((int)IDs.MELEE_IMPROVISED_SPEAR - (int)IDs.MELEE_BASEBALLBAT + 1)];
