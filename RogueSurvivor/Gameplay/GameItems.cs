...
namespace djack.RogueSurvivor.Gameplay
{
  ...
  internal static class GameItems
  {
    ...
    static public ItemGrenadeModel GRENADE {
      get {
        return m_Models[(int)Item_IDs.EXPLOSIVE_GRENADE] as ItemGrenadeModel;
      }
    }

    static public ItemGrenadePrimedModel GRENADE_PRIMED {
      get {
        return m_Models[(int)Item_IDs.EXPLOSIVE_GRENADE_PRIMED] as ItemGrenadePrimedModel;
      }
    }
    ...
    static public ItemBodyArmorModel ARMY_BODYARMOR {
      get {
        return m_Models[(int)Item_IDs.ARMOR_ARMY_BODYARMOR] as ItemBodyArmorModel;
      }
    }
    ...
    {
      get {
        return m_Models[(int)Item_IDs.ARMOR_CHAR_LIGHT_BODYARMOR] as ItemBodyArmorModel;
      }
    }

    static public ItemBodyArmorModel HELLS_SOULS_JACKET {
      get {
        return m_Models[(int)Item_IDs.ARMOR_HELLS_SOULS_JACKET] as ItemBodyArmorModel;
      }
    }

    static public ItemBodyArmorModel FREE_ANGELS_JACKET {
      get {
        return m_Models[(int)Item_IDs.ARMOR_FREE_ANGELS_JACKET] as ItemBodyArmorModel;
      }
    }

    static public ItemBodyArmorModel POLICE_JACKET {
      get {
        return m_Models[(int)Item_IDs.ARMOR_POLICE_JACKET] as ItemBodyArmorModel;
      }
    }

    static public ItemBodyArmorModel POLICE_RIOT {
      get {
        return m_Models[(int)Item_IDs.ARMOR_POLICE_RIOT] as ItemBodyArmorModel;
      }
    }

    static public ItemBodyArmorModel HUNTER_VEST {
      get {
        return m_Models[(int)Item_IDs.ARMOR_HUNTER_VEST] as ItemBodyArmorModel;
      }
    }
                              ...
                              ScentSprayData[] scent_data, TrapData[] trap_data, EntData[] ent_data)
    {
      ...
      // body armor
      _setModel(new ItemBodyArmorModel(Item_IDs.ARMOR_ARMY_BODYARMOR, DATA_ARMOR_ARMY.NAME, DATA_ARMOR_ARMY.PLURAL, GameImages.ITEM_ARMY_BODYARMOR, DATA_ARMOR_ARMY.PRO_HIT, DATA_ARMOR_ARMY.PRO_SHOT, DATA_ARMOR_ARMY.ENC, DATA_ARMOR_ARMY.WEIGHT, DATA_ARMOR_ARMY.FLAVOR));
      _setModel(new ItemBodyArmorModel(Item_IDs.ARMOR_CHAR_LIGHT_BODYARMOR, DATA_ARMOR_CHAR.NAME, DATA_ARMOR_CHAR.PLURAL, GameImages.ITEM_CHAR_LIGHT_BODYARMOR, DATA_ARMOR_CHAR.PRO_HIT, DATA_ARMOR_CHAR.PRO_SHOT, DATA_ARMOR_CHAR.ENC, DATA_ARMOR_CHAR.WEIGHT, DATA_ARMOR_CHAR.FLAVOR));
      _setModel(new ItemBodyArmorModel(Item_IDs.ARMOR_HELLS_SOULS_JACKET, DATA_ARMOR_HELLS_SOULS_JACKET.NAME, DATA_ARMOR_HELLS_SOULS_JACKET.PLURAL, GameImages.ITEM_HELLS_SOULS_JACKET, DATA_ARMOR_HELLS_SOULS_JACKET.PRO_HIT, DATA_ARMOR_HELLS_SOULS_JACKET.PRO_SHOT, DATA_ARMOR_HELLS_SOULS_JACKET.ENC, DATA_ARMOR_HELLS_SOULS_JACKET.WEIGHT, DATA_ARMOR_HELLS_SOULS_JACKET.FLAVOR));
      _setModel(new ItemBodyArmorModel(Item_IDs.ARMOR_FREE_ANGELS_JACKET, DATA_ARMOR_FREE_ANGELS_JACKET.NAME, DATA_ARMOR_FREE_ANGELS_JACKET.PLURAL, GameImages.ITEM_FREE_ANGELS_JACKET, DATA_ARMOR_FREE_ANGELS_JACKET.PRO_HIT, DATA_ARMOR_FREE_ANGELS_JACKET.PRO_SHOT, DATA_ARMOR_FREE_ANGELS_JACKET.ENC, DATA_ARMOR_FREE_ANGELS_JACKET.WEIGHT, DATA_ARMOR_FREE_ANGELS_JACKET.FLAVOR));
      _setModel(new ItemBodyArmorModel(Item_IDs.ARMOR_POLICE_JACKET, DATA_ARMOR_POLICE_JACKET.NAME, DATA_ARMOR_POLICE_JACKET.PLURAL, GameImages.ITEM_POLICE_JACKET, DATA_ARMOR_POLICE_JACKET.PRO_HIT, DATA_ARMOR_POLICE_JACKET.PRO_SHOT, DATA_ARMOR_POLICE_JACKET.ENC, DATA_ARMOR_POLICE_JACKET.WEIGHT, DATA_ARMOR_POLICE_JACKET.FLAVOR));
      _setModel(new ItemBodyArmorModel(Item_IDs.ARMOR_POLICE_RIOT, DATA_ARMOR_POLICE_RIOT.NAME, DATA_ARMOR_POLICE_RIOT.PLURAL, GameImages.ITEM_POLICE_RIOT_ARMOR, DATA_ARMOR_POLICE_RIOT.PRO_HIT, DATA_ARMOR_POLICE_RIOT.PRO_SHOT, DATA_ARMOR_POLICE_RIOT.ENC, DATA_ARMOR_POLICE_RIOT.WEIGHT, DATA_ARMOR_POLICE_RIOT.FLAVOR));
      _setModel(new ItemBodyArmorModel(Item_IDs.ARMOR_HUNTER_VEST, DATA_ARMOR_HUNTER_VEST.NAME, DATA_ARMOR_HUNTER_VEST.PLURAL, GameImages.ITEM_HUNTER_VEST, DATA_ARMOR_HUNTER_VEST.PRO_HIT, DATA_ARMOR_HUNTER_VEST.PRO_SHOT, DATA_ARMOR_HUNTER_VEST.ENC, DATA_ARMOR_HUNTER_VEST.WEIGHT, DATA_ARMOR_HUNTER_VEST.FLAVOR));
