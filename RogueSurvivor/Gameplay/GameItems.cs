...
namespace djack.RogueSurvivor.Gameplay
{
  internal class GameItems : ItemModelDB
  {
    ...
    private void CreateModels()
    {
      ...
      // melee weapons
      _setModel(IDs.MELEE_BASEBALLBAT, new ItemMeleeWeaponModel(DATA_MELEE_BASEBALLBAT.NAME, GameImages.ITEM_BASEBALL_BAT, new Attack(AttackKind.PHYSICAL, SMASH, DATA_MELEE_BASEBALLBAT.ATK, DATA_MELEE_BASEBALLBAT.DMG, DATA_MELEE_BASEBALLBAT.STA), DATA_MELEE_BASEBALLBAT.FLAVOR) {
          IsFragile = DATA_MELEE_BASEBALLBAT.ISFRAGILE,
          StackingLimit = DATA_MELEE_BASEBALLBAT.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_COMBAT_KNIFE, new ItemMeleeWeaponModel(DATA_MELEE_COMBAT_KNIFE.NAME, GameImages.ITEM_COMBAT_KNIFE, new Attack(AttackKind.PHYSICAL, STAB, DATA_MELEE_COMBAT_KNIFE.ATK, DATA_MELEE_COMBAT_KNIFE.DMG, DATA_MELEE_COMBAT_KNIFE.STA), DATA_MELEE_COMBAT_KNIFE.FLAVOR) {
          IsFragile = DATA_MELEE_COMBAT_KNIFE.ISFRAGILE,
          StackingLimit = DATA_MELEE_COMBAT_KNIFE.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_CROWBAR, new ItemMeleeWeaponModel(DATA_MELEE_CROWBAR.NAME, GameImages.ITEM_CROWBAR, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_CROWBAR.ATK, DATA_MELEE_CROWBAR.DMG, DATA_MELEE_CROWBAR.STA), DATA_MELEE_CROWBAR.FLAVOR) {
          IsFragile = DATA_MELEE_CROWBAR.ISFRAGILE,
          StackingLimit = DATA_MELEE_CROWBAR.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_GOLFCLUB, new ItemMeleeWeaponModel(DATA_MELEE_GOLFCLUB.NAME, GameImages.ITEM_GOLF_CLUB, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_GOLFCLUB.ATK, DATA_MELEE_GOLFCLUB.DMG, DATA_MELEE_GOLFCLUB.STA), DATA_MELEE_GOLFCLUB.FLAVOR) {
          IsFragile = DATA_MELEE_GOLFCLUB.ISFRAGILE,
          StackingLimit = DATA_MELEE_GOLFCLUB.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_IRON_GOLFCLUB, new ItemMeleeWeaponModel(DATA_MELEE_IRON_GOLFCLUB.NAME, GameImages.ITEM_IRON_GOLF_CLUB, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_IRON_GOLFCLUB.ATK, DATA_MELEE_IRON_GOLFCLUB.DMG, DATA_MELEE_IRON_GOLFCLUB.STA), DATA_MELEE_IRON_GOLFCLUB.FLAVOR) {
          IsFragile = DATA_MELEE_IRON_GOLFCLUB.ISFRAGILE,
          StackingLimit = DATA_MELEE_IRON_GOLFCLUB.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_HUGE_HAMMER, new ItemMeleeWeaponModel(DATA_MELEE_HUGE_HAMMER.NAME, GameImages.ITEM_HUGE_HAMMER, new Attack(AttackKind.PHYSICAL, SMASH, DATA_MELEE_HUGE_HAMMER.ATK, DATA_MELEE_HUGE_HAMMER.DMG, DATA_MELEE_HUGE_HAMMER.STA), DATA_MELEE_HUGE_HAMMER.FLAVOR) {
          IsFragile = DATA_MELEE_HUGE_HAMMER.ISFRAGILE,
          StackingLimit = DATA_MELEE_HUGE_HAMMER.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_SHOVEL, new ItemMeleeWeaponModel(DATA_MELEE_SHOVEL.NAME, GameImages.ITEM_SHOVEL, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_SHOVEL.ATK, DATA_MELEE_SHOVEL.DMG, DATA_MELEE_SHOVEL.STA), DATA_MELEE_SHOVEL.FLAVOR) {
          IsFragile = DATA_MELEE_SHOVEL.ISFRAGILE,
          StackingLimit = DATA_MELEE_SHOVEL.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_SHORT_SHOVEL, new ItemMeleeWeaponModel(DATA_MELEE_SHORT_SHOVEL.NAME, GameImages.ITEM_SHORT_SHOVEL, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_SHORT_SHOVEL.ATK, DATA_MELEE_SHORT_SHOVEL.DMG, DATA_MELEE_SHORT_SHOVEL.STA), DATA_MELEE_SHORT_SHOVEL.FLAVOR){
          IsFragile = DATA_MELEE_SHORT_SHOVEL.ISFRAGILE,
          StackingLimit = DATA_MELEE_SHORT_SHOVEL.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_TRUNCHEON, new ItemMeleeWeaponModel(DATA_MELEE_TRUNCHEON.NAME, GameImages.ITEM_TRUNCHEON, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_TRUNCHEON.ATK, DATA_MELEE_TRUNCHEON.DMG, DATA_MELEE_TRUNCHEON.STA), DATA_MELEE_TRUNCHEON.FLAVOR) {
          IsFragile = DATA_MELEE_TRUNCHEON.ISFRAGILE,
          StackingLimit = DATA_MELEE_TRUNCHEON.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_IMPROVISED_CLUB, new ItemMeleeWeaponModel(DATA_MELEE_IMPROVISED_CLUB.NAME, GameImages.ITEM_IMPROVISED_CLUB, new Attack(AttackKind.PHYSICAL, STRIKE, DATA_MELEE_IMPROVISED_CLUB.ATK, DATA_MELEE_IMPROVISED_CLUB.DMG, DATA_MELEE_IMPROVISED_CLUB.STA), DATA_MELEE_IMPROVISED_CLUB.FLAVOR) {
          IsFragile = DATA_MELEE_IMPROVISED_CLUB.ISFRAGILE,
          StackingLimit = DATA_MELEE_IMPROVISED_CLUB.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_IMPROVISED_SPEAR, new ItemMeleeWeaponModel(DATA_MELEE_IMPROVISED_SPEAR.NAME, GameImages.ITEM_IMPROVISED_SPEAR, new Attack(AttackKind.PHYSICAL, PIERCE, DATA_MELEE_IMPROVISED_SPEAR.ATK, DATA_MELEE_IMPROVISED_SPEAR.DMG, DATA_MELEE_IMPROVISED_SPEAR.STA), DATA_MELEE_IMPROVISED_SPEAR.FLAVOR) {
          IsFragile = DATA_MELEE_IMPROVISED_SPEAR.ISFRAGILE,
          StackingLimit = DATA_MELEE_IMPROVISED_SPEAR.STACKINGLIMIT
      });
      _setModel(IDs.MELEE_SMALL_HAMMER, new ItemMeleeWeaponModel(DATA_MELEE_SMALL_HAMMER.NAME, GameImages.ITEM_SMALL_HAMMER, new Attack(AttackKind.PHYSICAL, SMASH, DATA_MELEE_SMALL_HAMMER.ATK, DATA_MELEE_SMALL_HAMMER.DMG, DATA_MELEE_SMALL_HAMMER.STA), DATA_MELEE_SMALL_HAMMER.FLAVOR) {
          IsFragile = DATA_MELEE_SMALL_HAMMER.ISFRAGILE,
          StackingLimit = DATA_MELEE_SMALL_HAMMER.STACKINGLIMIT
      });
      _setModel(IDs.UNIQUE_JASON_MYERS_AXE, new ItemMeleeWeaponModel(DATA_MELEE_UNIQUE_JASON_MYERS_AXE.NAME, GameImages.ITEM_JASON_MYERS_AXE, new Attack(AttackKind.PHYSICAL, SLASH, DATA_MELEE_UNIQUE_JASON_MYERS_AXE.ATK, DATA_MELEE_UNIQUE_JASON_MYERS_AXE.DMG, DATA_MELEE_UNIQUE_JASON_MYERS_AXE.STA), DATA_MELEE_UNIQUE_JASON_MYERS_AXE.FLAVOR, true));
      _setModel(IDs.UNIQUE_FAMU_FATARU_KATANA, new ItemMeleeWeaponModel(DATA_MELEE_UNIQUE_FAMU_FATARU_KATANA.NAME, GameImages.ITEM_FAMU_FATARU_KATANA, new Attack(AttackKind.PHYSICAL, SLASH, DATA_MELEE_UNIQUE_FAMU_FATARU_KATANA.ATK, DATA_MELEE_UNIQUE_FAMU_FATARU_KATANA.DMG, DATA_MELEE_UNIQUE_FAMU_FATARU_KATANA.STA), DATA_MELEE_UNIQUE_FAMU_FATARU_KATANA.FLAVOR, true));
      _setModel(IDs.UNIQUE_BIGBEAR_BAT, new ItemMeleeWeaponModel(DATA_MELEE_UNIQUE_BIGBEAR_BAT.NAME, GameImages.ITEM_BIGBEAR_BAT, new Attack(AttackKind.PHYSICAL, SMASH, DATA_MELEE_UNIQUE_BIGBEAR_BAT.ATK, DATA_MELEE_UNIQUE_BIGBEAR_BAT.DMG, DATA_MELEE_UNIQUE_BIGBEAR_BAT.STA), DATA_MELEE_UNIQUE_BIGBEAR_BAT.FLAVOR, true));
      _setModel(IDs.UNIQUE_ROGUEDJACK_KEYBOARD, new ItemMeleeWeaponModel(DATA_MELEE_UNIQUE_ROGUEDJACK_KEYBOARD.NAME, GameImages.ITEM_ROGUEDJACK_KEYBOARD, new Attack(AttackKind.PHYSICAL, RogueGame.VERB_BASH, DATA_MELEE_UNIQUE_ROGUEDJACK_KEYBOARD.ATK, DATA_MELEE_UNIQUE_ROGUEDJACK_KEYBOARD.DMG, DATA_MELEE_UNIQUE_ROGUEDJACK_KEYBOARD.STA), DATA_MELEE_UNIQUE_ROGUEDJACK_KEYBOARD.FLAVOR, true));
      _setModel(IDs.UNIQUE_FATHER_TIME_SCYTHE, new ItemMeleeWeaponModel(DATA_MELEE_UNIQUE_FATHER_TIME_SCYTHE.NAME, GameImages.ITEM_FATHER_TIME_SCYTHE, new Attack(AttackKind.PHYSICAL, SLASH, DATA_MELEE_UNIQUE_FATHER_TIME_SCYTHE.ATK, DATA_MELEE_UNIQUE_FATHER_TIME_SCYTHE.DMG, DATA_MELEE_UNIQUE_FATHER_TIME_SCYTHE.STA), DATA_MELEE_UNIQUE_FATHER_TIME_SCYTHE.FLAVOR, true));
