...
namespace djack.RogueSurvivor.Gameplay
{
  internal class GameTiles : TileModelDB
  {
    ...
    private static readonly TileModel[] m_Models = new TileModel[]{
      TileModel.UNDEF,
      new TileModel(GameImages.TILE_FLOOR_ASPHALT, LIT_GRAY1, true, true) { ID = (int)IDs.FLOOR_ASPHALT },
      new TileModel(GameImages.TILE_FLOOR_CONCRETE, LIT_GRAY2, true, true) { ID = (int)IDs.FLOOR_CONCRETE },
      new TileModel(GameImages.TILE_FLOOR_GRASS, Color.Green, true, true) { ID = (int)IDs.FLOOR_GRASS },
      new TileModel(GameImages.TILE_FLOOR_OFFICE, LIT_GRAY3, true, true) { ID = (int)IDs.FLOOR_OFFICE },
      new TileModel(GameImages.TILE_FLOOR_PLANKS, LIT_BROWN, true, true) { ID = (int)IDs.FLOOR_PLANKS },
      new TileModel(GameImages.TILE_FLOOR_SEWER_WATER, Color.Blue, true, true, GameImages.TILE_FLOOR_SEWER_WATER_COVER) { ID = (int)IDs.FLOOR_SEWER_WATER },
      new TileModel(GameImages.TILE_FLOOR_TILES, LIT_GRAY2, true, true) { ID = (int)IDs.FLOOR_TILES },
      new TileModel(GameImages.TILE_FLOOR_WALKWAY, LIT_GRAY2, true, true) { ID = (int)IDs.FLOOR_WALKWAY },
      new TileModel(GameImages.TILE_ROAD_ASPHALT_EW, LIT_GRAY1, true, true) { ID = (int)IDs.ROAD_ASPHALT_EW },
      new TileModel(GameImages.TILE_ROAD_ASPHALT_NS, LIT_GRAY1, true, true) { ID = (int)IDs.ROAD_ASPHALT_NS },
      new TileModel(GameImages.TILE_RAIL_EW, LIT_GRAY1, true, true) { ID = (int)IDs.RAIL_EW },
      new TileModel(GameImages.TILE_WALL_BRICK, DRK_GRAY1, false, false) { ID = (int)IDs.WALL_BRICK },
      new TileModel(GameImages.TILE_WALL_CHAR_OFFICE, DRK_RED, false, false) { ID = (int)IDs.WALL_CHAR_OFFICE },
      new TileModel(GameImages.TILE_WALL_HOSPITAL, Color.White, false, false) { ID = (int)IDs.WALL_HOSPITAL },
      new TileModel(GameImages.TILE_WALL_STONE, Color.CadetBlue, false, false) { ID = (int)IDs.WALL_POLICE_STATION },
      new TileModel(GameImages.TILE_WALL_SEWER, Color.DarkGreen, false, false) { ID = (int)IDs.WALL_SEWER },
      new TileModel(GameImages.TILE_WALL_STONE, DRK_GRAY1, false, false) { ID = (int)IDs.WALL_STONE },
      new TileModel(GameImages.TILE_WALL_STONE, Color.Blue, false, false) { ID = (int)IDs.WALL_SUBWAY },
      new TileModel(GameImages.TILE_RAIL_NS, LIT_GRAY1, true, true) { ID = (int)IDs.RAIL_NS },
      new TileModel(GameImages.TILE_RAIL_SWNE, LIT_GRAY1, true, true) { ID = (int)IDs.RAIL_SWNE },
      new TileModel(GameImages.TILE_RAIL_SWNE_WALL_W, Color.Blue, false, false) { ID = (int)IDs.RAIL_SWNE_WALL_W },
      new TileModel(GameImages.TILE_RAIL_SWNE_WALL_E, Color.Blue, false, false) { ID = (int)IDs.RAIL_SWNE_WALL_E },
      new TileModel(GameImages.TILE_RAIL_SENW, LIT_GRAY1, true, true) { ID = (int)IDs.RAIL_SENW },
      new TileModel(GameImages.TILE_RAIL_SENW_WALL_W, Color.Blue, false, false) { ID = (int)IDs.RAIL_SENW_WALL_W },
      new TileModel(GameImages.TILE_RAIL_SENW_WALL_E, Color.Blue, false, false) { ID = (int)IDs.RAIL_SENW_WALL_E },
    };
