...
{
  public sealed class ItemAmmoModel : Data.Model.Item
  {
    ...
    public override ItemAmmo create() => new(this);
    public override ItemAmmo from(in Item_s src) => new(this, src.QtyLike);
  }
}
