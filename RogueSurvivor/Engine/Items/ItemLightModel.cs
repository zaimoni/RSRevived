...
{
  public sealed class ItemLightModel : Data.Model.Item
  {
    ...
    public override ItemLight create() => new(this);
    public override ItemLight from(in Item_s src) => new(this, src.QtyLike);
